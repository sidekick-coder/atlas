...
const OUTPUT_DIR = path.resolve(import.meta.dirname, "..", "projects");
...
for (let i = 1; i <= COUNT; i++) {
    ...
    const dir = path.join(OUTPUT_DIR, `${number}_${slug}`);
    const filename = path.join(dir, "index.yml");
...
console.log(`Generated ${COUNT} files in ${OUTPUT_DIR}`);
